...
export default function PageScanOut() {
  ...
  return (
    ...
    >
      <ProCard
        title="Scan Out"
        extra="2023-01-01 12:32:00"
        // bordered
        headerBordered
        split={responsive ? "horizontal" : "vertical"}
      >
        <ProCard split="horizontal" gutter={[8,8]} >
          ...
          <ProCard split={responsive ? "horizontal" : "vertical"} bordered>
            <ProCard title="Information">
              <Space size={[0, 8]} wrap>
                ...
                <Tag color="cyan"><span style={{ fontSize: 14 }}>Driver : SD Somchai B.0953708493</span> </Tag>
                <Tag color="purple"><span style={{ fontSize: 14 }}>Vehicle : 2ฒฌ9381</span></Tag>
              </Space>
            </ProCard>
            <ProCard title="">
              <ProCard>
        ...
        <ProCard
          title={`Assort Code : 103-20-1`}
          extra={
            <span style={{ fontSize: 16 }}>
              <b>No. of parcels 0/0</b>
            </span>
          }
        >
          <PTable />
